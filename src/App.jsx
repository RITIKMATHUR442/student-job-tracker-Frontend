...
//     // https://student-job-tracker-backend-zwry.onrender.com
...
//       setEditingId(null);
//     } else {
//       await axios.post("https://student-job-tracker-backend-zwry.onrender.com/api/jobs", form);
//     }
...
//   // };
//   const handleEdit = (job) => {
//     const formattedDate = job.dateOfApplication?.split("T")[0]; // safely get yyyy-MM-dd
//     setForm({
//       ...job,
